...
`;function ut(t,e,i,s={}){s=s||{},i=null==i?{}:i;const n=new Event(e,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});return n.detail=i,t.dispatchEvent(n),n}!function(t,e){void 0===e&&(e={});var i=e.insertAt;if(t&&"undefined"!=typeof document){var s=document.head||document.getElementsByTagName("head")[0],n=document.createElement("style");n.type="text/css","top"===i&&s.firstChild?s.insertBefore(n,s.firstChild):s.appendChild(n),n.styleSheet?n.styleSheet.cssText=t:n.appendChild(document.createTextNode(t))}}(pt);const ft=[0,1],gt=[.5,1],mt=["column","row"],vt=["climate"],yt={header:{},layout:{mode:{}}};class _t extends at{constructor(){super(...arguments),this.config={}}static getStubConfig(){return{...yt}}setConfig(t){this.config=t||{...yt}}_openLink(){window.open("https://github.com/sctale/hass-xiaokongtiao/blob/master/README.md")}render(){return this.hass?L`
